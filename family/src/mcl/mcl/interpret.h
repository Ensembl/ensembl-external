/*
// interpret.h          Interpretation of clusterings
*/

#ifndef MCL_INTERPRETH__
#define MCL_INTERPRETH__

#include "nonema/matrix.h"

/*
////////////////////////////////////////////////////////////////////////////////
//                      struct mcxIpretParam
//
//                      mcxMatrix* clusterMtx mcxInterpret
//                      (  const mcxMatrix*          mtx
...
//    greatest use of mcxInterpret() lies in applying it to iterands of the
...
//    mcxInterpret works by associating a DAG with its input matrix such
...
//    mcxInterpret does the best it can in associating a DAG with any
...
//    The members of mcxInterpretParam are used for transforming an input
...
mcxIpretParam* mcxIpretParamNew(void);

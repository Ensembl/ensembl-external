...
,  "\n"
   ...
   "  <meet file>   file where the meet is written (in MCL matrix"
                     " format).\n"
   "                The meet is the largest clustering that is a\n"
   "                subclustering of all clusterings specified.\n"
   "  <cl file>     file containing clustering (in MCL matrix"
                     " format).\n"
   "                At least one such file is required.\n"
   "                Two or more clusterings make it"
                     " interesting.\n"
   "\n"
)
         ;  exit(0)
   ...
   ;  mcxMatrixWriteAscii(lft, xfOut, -1, EXIT_ON_FAIL)

# module Bio::EnsEMBL::ExternalData::Haplotype::Select.pm
# cared by Pedro M. Gomez-Fabre <pgf18872@gsk.com>
#
#
...
package Bio::EnsEMBL::ExternalData::Haplotype::Select;
# package Select;
use vars qw(@ISA);
...
#------------------------
    ...
    # if the input is not well formed complained and exit.
    _check_input($self);

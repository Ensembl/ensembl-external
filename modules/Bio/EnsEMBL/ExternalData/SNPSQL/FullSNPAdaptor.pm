...
Bio::EnsEMBL::ExternalData::SNPSQL::FullSNPAdaptor - Class for a sequence variation
database providing 'heavy' external features for EnsEMBL

=head1 SYNOPSIS

   # first make an Object which conforms to interface
   # Bio::EnsEMBL::DB::ExternalFeatureFactoryI
   $snpdb = Bio::EnsEMBL::ExternalData::SNPSQL::FullSNPAdaptor->new( -dbname => 'snp'
							  -user => 'root'
							  );

   # you can make an obj with external databases
   $dbobj = Bio::EnsEMBL::DBSQL::FullSNPAdaptor->new( -host => 'localhost',
					   -dbname => 'ensembl',
					   -external => [ $snpdb ] );
...
package Bio::EnsEMBL::ExternalData::SNPSQL::FullSNPAdaptor;
